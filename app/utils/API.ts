...
export const authAPI = {
  ...
  logout: (userId: string) =>
    API.post('/admin/auth/logout', { userId }),
  register: (userData: any) =>
    API.post('/admin/auth/register', userData),
};
...
export const customerAPI = {
  ...
  create: (customerData: any) =>
    API.post('/admin/customers', customerData),
...
export const workOrderAPI = {
  getAll: (params?: any) =>
    API.get('/admin/work-orders', { params }),
  getById: (id: string) =>
    API.get(`/admin/work-orders/${id}`),
  create: (workOrderData: any) =>
    API.post('/admin/work-orders', workOrderData),
  ...
  getStats: () =>
    API.get('/admin/work-orders/stats'),
...
export const scadaAPI = {
  getAll: (params?: any) =>
    API.get('/admin/scada', { params }),
  getById: (id: string) =>
    API.get(`/admin/scada/${id}`),
  create: (scadaData: any) =>
    API.post('/admin/scada', scadaData),
  ...
  getAlarms: (params?: any) =>
    API.get('/admin/scada/alarms', { params }),
  acknowledgeAlarm: (plantId: string, alarmId: string, acknowledgedBy: string) =>
    API.post(`/admin/scada/alarm/${plantId}/${alarmId}/acknowledge`, { acknowledgedBy }),
  resolveAlarm: (plantId: string, alarmId: string) =>
    API.post(`/admin/scada/alarm/${plantId}/${alarmId}/resolve`),
  getStats: () =>
    API.get('/admin/scada/stats'),
  getPlants: () =>
    API.get('/admin/scada/plants'),
};

// Water Quality API
export const waterQualityAPI = {
  getAll: (params?: any) =>
    API.get('/admin/water-quality', { params }),
  getById: (id: string) =>
    API.get(`/admin/water-quality/${id}`),
  ...
  getStats: () =>
    API.get('/admin/water-quality/stats'),
  ...
  acknowledgeAlert: (alertId: string, acknowledgedBy: string) =>
    API.post(`/admin/water-quality/alerts/${alertId}/acknowledge`, { acknowledgedBy }),
...
export const smartMeterAPI = {
  getAll: (params?: any) =>
    API.get('/admin/smart-meters', { params }),
  getById: (id: string) =>
    API.get(`/admin/smart-meters/${id}`),
  create: (meterData: any) =>
    API.post('/admin/smart-meters', meterData),
  update: (id: string, meterData: any) =>
    API.put(`/admin/smart-meters/${id}`, meterData),
  delete: (id: string) =>
    API.delete(`/admin/smart-meters/${id}`),
  ...
  getStats: () =>
    API.get('/admin/smart-meters/stats'),
  ...
  getConnectivityStatus: () =>
    API.get('/admin/smart-meters/connectivity'),
  getBatteryStatus: () =>
    API.get('/admin/smart-meters/battery'),
  exportData: (params?: any) =>
...
export const waterCreditAPI = {
  ...
  getById: (id: string) =>
    API.get(`/waterCredit/getWaterCreditById/${id}`),
  ...
  delete: (id: string) =>
    API.delete(`/waterCredit/deleteWaterCredit/${id}`),
};
...
export const reportAPI = {
  ...
  create: (reportData: any) =>
    API.post('/report/create', reportData),
